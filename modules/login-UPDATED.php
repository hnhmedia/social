...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        try {
            ...
            // Get user by email
            $user = $db->where('email', $email)->getOne('si_users');
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                if ($user['status'] !== 'active') {
                    ...
                    // Update last login
                    $db->where('id', $user['id'])->update('si_users', [
                        'last_login' => date('Y-m-d H:i:s')
                    ]);
                    
                    // Redirect to dashboard or intended page
                    $redirect = isset($_GET['redirect']) ? $_GET['redirect'] : Config::baseUrl('dashboard');
    ...
    <div class="login-container">
        ...
        <div class="login-body">
            ...
            <form method="POST" action="">
                ...
                <div class="links">
                    <a href="<?php echo Config::baseUrl('forgot-password'); ?>" class="link">Forgot password?</a>
                    <a href="<?php echo Config::baseUrl(); ?>" class="link">Back to home</a>
                </div>
            </form>
            
            <div class="register-link">
                Don't have an account? <a href="<?php echo Config::baseUrl('register'); ?>">Create one now</a>
            </div>
        </div>
    </div>
</body>
