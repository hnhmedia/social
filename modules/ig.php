...
$realFollowersPacks = [
    ...
    ['qty' => 250, 'price' => 5.95, 'label' => 'Save 10%'],
    ['qty' => 500, 'price' => 9.95, 'label' => 'Save 15%'],
    ['qty' => 1000, 'price' => 15.95, 'label' => 'Save 20%'],
    ['qty' => 2500, 'price' => 29.95, 'label' => 'Save 25%'],
    ['qty' => 5000, 'price' => 49.95, 'label' => 'Save 30%'],
    ['qty' => 10000, 'price' => 89.95, 'label' => 'Save 35%'],
    ['qty' => 15000, 'price' => 129.95, 'label' => 'Save 40%'],
];
...
.pkg-card.selected {
    background: linear-gradient(135deg, #fc481c, #ff6b47); border-color: #fc481c; color: #fff;
}
...
.pkg-card .pkg-check {
    ...
    background: #fff; color: #0080ff; display: none; align-items: center; justify-content: center; padding: 3px;
}
.pkg-card.selected .pkg-check { display: flex; }
.pkg-qty { font-size: 1.125rem; font-weight: 600; line-height: 1; display: block; color: #1e293b; }
.pkg-label-text { font-weight: 600; margin-top: -2px; white-space: nowrap; display: block; font-size: 0.8rem; }
.pkg-save-badge {
    display: inline-block; margin-top: 5px; padding: 1px 6px; border-radius: 4px;
    font-size: 0.65rem; font-weight: 700; white-space: nowrap;
}
.pkg-card:not(.selected) .pkg-save-badge { background: #dcfce7; color: #16a34a; }
.pkg-card.selected .pkg-save-badge { background: rgba(255,255,255,0.3); color: #fff; }
